...
btn5.addEventListener("click", function(){
	if (tg.MainButton.isVisible) {
		...
		tg.MainButton.setText("Посмотреть информацию о кухне!");
		item = "Кухня";
		tg.MainButton.show();
	}
});
...
btn6.addEventListener("click", function(){
	if (tg.MainButton.isVisible) {
		...
		tg.MainButton.setText("Посмотреть информацию о кластере!");
		item = "Кластер";
		tg.MainButton.show();
	}
});
